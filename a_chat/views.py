    ...
    if chat_group.groupchat_name:
        if request.user not in chat_group.members.all():
            if request.user.emailaddress_set.filter(verified=True).exists():
                ...
                messages.warning(request, 'You are not verified your email address to view this chat.')
...
def chatroom_delete_view(request, chatroom_name):
    ...
    if request.method == 'POST':
        ...
        return redirect('home')
    return render(request, 'a_chat/chatroom_delete.html', {'chat_group': chat_group})
...
def chatroom_leave_view(request, chatroom_name):
    ...
    if request.method == 'POST':
        ...
        return redirect('home')
    return render(request, 'a_chat/chatroom_leave.html', {'chat_group': chat_group})